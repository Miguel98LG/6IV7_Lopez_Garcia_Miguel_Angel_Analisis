...
//es para definir el algoritmo cifrado
import javax.crypto.*;

// para el algoritmo
import javax.crypto.interfaces.*;
//para definir el tamaña de la clave y subclaves
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
        Lo primero es que vamos a crear un programa mediante el cual debe leer
        un archivo de texto plano
        se debe introducir una clave
        ...
        */
        ...
        //no es posible distinguir lo bytes de un caracter 
        ...
        /*
        El tipo de cifrado es DES, es de tipo Simetrico significa que la clave de cifrado 
        es la misma para descifrar.
        ...
        */
        ...
        int bytesleidos = entrada.read(buffer,0,10000);
        ...
        //ahora a descifrar
         ...
         System.out.println("3.- Cifrar un fichero con DES :"
        + args[0] + ".cifrado: "
        + args[0] + ".descifrado");
        ...
        bytesleidos = entrada.read(buffer,0,10000);
    ...
    private static void mensajeAyuda() {
        ...
        System.out.println("Favor de ingresar un archivo de " + 
                "texto plano, sino np funciona sea .txt");
    }
