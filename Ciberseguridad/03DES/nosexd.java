    ...
    private static void placeComponents(JPanel panel) {
        ...
        selectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Permitir seleccionar archivos con las extensiones .txt, .cifrado, .descifrado
                fileChooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Archivos de texto, cifrado o descifrado", "txt", "cifrado", "descifrado"));
        ...
        encryptButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Mostrar el archivo cifrado en el JTextArea (en formato hexadecimal)
                    resultArea.setText("Archivo cifrado exitosamente. Contenido cifrado:\n");
                    resultArea.append(bytesToHex(buffercifrado));

                    // Guardar el archivo cifrado
                    String cifradoPath = filePath + ".cifrado";
                    FileOutputStream fileOut = new FileOutputStream(cifradoPath);
                    fileOut.write(salida.toByteArray());
                    fileOut.close();

                    resultArea.append("\nArchivo cifrado guardado como: " + cifradoPath);
        ...
        decryptButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String descifradoPath = filePath + ".descifrado";
                    FileOutputStream fileOut = new FileOutputStream(descifradoPath);
                    fileOut.write(salidaDescifrada.toByteArray());
                    fileOut.close();

                    resultArea.append("\nArchivo descifrado guardado como: " + descifradoPath);
